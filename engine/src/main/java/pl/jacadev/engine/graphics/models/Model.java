 ...
 */
public class Model implements Unloadable {
     ...
     *      2 - normal attribute
     */
    public Model(FloatBuffer vertices, FloatBuffer texCoords, FloatBuffer normals, IntBuffer indices, int numElements, int[] attributes) {
     ...
     *      2 - normal attribute
     */
    public Model(float[] vertices, float[] texCoords, float[] normals, int[] indices, int[] attributes) {
     ...
     *      2 - normal attribute
     */
    public Model(int vertexBuff, int texCoordBuff, int normalBuff, int indexBuff, int indices, int[] attributes) {
    ...
    /**
     * Binds each vbo and draws model.
     */
    public void draw(){
        bind();
        render();
